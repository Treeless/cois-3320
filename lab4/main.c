/*
  ...
  Name: LAB4 - Shortest Job Remaining Lab - Operating Systems Fundamentals
  Description: Simulation for running jobs using the shortest job remaining algorithm.
  Language: C
*/
...
int main(){
  ...
  while(jobsDone < NUMBER_OF_J){
    ...
    //Every single iteration, reset the jobPosition to -1, lets the checks happen
    jobPosition = -1;
  }
